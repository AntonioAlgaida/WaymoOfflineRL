# ======================================================================================
# preprocess_bc_stage_2_5.py
#
# Description:
#   This script performs offline preprocessing for the Stage 2.5 Kinematic
#   Behavioral Cloning (BC-K) agent. It reads the parsed .npz data and
#   calculates a physically plausible action vector (acceleration, steering_angle)
...
from src.shared.utils import normalize_angle, TrainingConfig
